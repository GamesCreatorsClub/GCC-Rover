...
def loop():
    global doReadGyro, doReadAccel, lastTimeGyroRead, lastTimeAccelRead, continuousModeGyro, continuousModeGyroCalibrate, continuousModeAccel, continuousModeAccelCalibrate
